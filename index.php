		...
		<div class="banner">
			<img class="banner__img" src="<?php echo get_template_directory_uri() ?>/images/banner.jpg">
				<div class="banner__text">
					...
					<button class=banner__button>Lo necesito</button>
				</div>
		</div>
		<div class="products">
			<div class="product">
				...
				<a href="http://localhost/5retos/product/" class="product__button">Compra ahora</a>
			</div>
			<div class="product">
				<img class="product__img" src="<?php echo get_template_directory_uri() ?>/images/product_Test2.jpg" alt="Producto">
				<h3 class="product__name">Sublime serum</h3>
				<p class="product__price">100€</p>
				<a class="product__button">Compra ahora</a>
			</div>
		</div>
	</main><!-- .site-main -->
